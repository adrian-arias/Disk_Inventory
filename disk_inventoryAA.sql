...
--                                              --
-- 3/19/2021: Created Views and  displayed      --
-- disc borrowers with date and the             --
-- amount of times they borrowed it.            --
--                                              --
-- 3/31/2021: Created stored procedures for     --
-- artist, borrower, and disc tables.           --
--------------------------------------------------
--Project 2
...
--Stored procedures created for artist table
--Drop and Insert sp_ins_artist
...
GO
EXECUTE sp_ins_artist 'Bob', 'Jones', 1
GO
EXECUTE sp_ins_artist NULL, 'Jones', 1   --Throws Error to show message
GO

--Drop and Update sp_upd_artist
...
GO
EXECUTE sp_upd_artist 21, 'Bob', 'Jones2 Updated', 1
GO
EXECUTE sp_upd_artist 21, NULL, 'Jones', 1   --Throws Error to show message
GO

--Drop and Delete sp_del_artist
...
GO
EXECUTE sp_del_artist 1          --Throws Error to show message
GO


--Stored procedures created for borrower table
--Drop and Insert sp_ins_borrower
...
GO
EXECUTE sp_ins_borrower 'Jones', 'Joe', '143-113-1254'
GO
EXECUTE sp_ins_borrower NULL, 'Jones', 1   --Throws Error to show message
GO

--Drop and Update sp_upd_borrower
...
GO
EXECUTE sp_upd_borrower 21, 'Jones edited', 'Joe', '143-113-1254'
GO
EXECUTE sp_upd_borrower 21,  NULL , 'Joe', '143-113-1254'   --Throws Error to show message
GO


--Drop and Delete sp_del_borrower
...
GO
EXECUTE sp_del_borrower 1            --Throws Error to show message
GO


--Stored procedures created for disc table
--Drop and Insert sp_ins_disc
...
GO
EXECUTE sp_ins_disc 'Under Pressure', '4-20-2018', 1, 1, 1
GO
EXECUTE sp_ins_disc NULL , '4-20-2018', 1, 1, 1  --Throws Error to show message
GO

--Drop and Update sp_upd_disc
...
GO
EXECUTE sp_upd_disc 22, 'Under Pressure edited', '3-20-2018', 1, 3, 2
GO
EXECUTE sp_upd_disc 22,  NULL , '4-20-2018', 1, 1, 1  --Throws Error to show message
GO

--Drop and Delete sp_del_disc
...
GO
EXECUTE sp_del_disc 1      --Throws Error to show message
GO
